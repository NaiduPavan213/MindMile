...
// Roadmaps Page Icons & Detail Page Icons
...
export const ConnectionRequestIcon = () => (
  <svg
...
export const FontSizeIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M3 15s4 0 4-4V5h4v6s0 4 4 4 M14 5h4M16 5v10"
    />
  </svg>
);

// Premium Page Icons
export const PremiumStarIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const AdvancedAnalyticsIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
export const AIMentorIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7zM9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z"
    />
  </svg>
);
export const ExclusiveContentIcon = ({ className }) => (
  <svg
    className={className}
    fill="none"
    viewBox="0 0 24 24"
...
// Re-export smaller icons used across the app
export { ArticleIcon } from "./CardIcons";
