        ...
        return (
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            <ToggleSwitch
              ...
              setEnabled={(val) =>
                setPrivacy((p) => ({ ...p, showProfileToPublic: val }))
              }
            />
            <div className="py-3">
              <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">
              ...
              <select
                ...
                onChange={(e) =>
                  setPrivacy((p) => ({ ...p, showConnections: e.target.value }))
                }
                className="input-field"
              >
            ...
            <div className="py-3">
              ...
              <select
                ...
                onChange={(e) =>
                  setPrivacy((p) => ({ ...p, allowMessages: e.target.value }))
                }
                className="input-field"
              >
                <option value="everyone">Everyone</option>
        ...
        return (
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            <ToggleSwitch
              ...
              setEnabled={(val) =>
                setNotifications((n) => ({ ...n, newConnection: val }))
              }
            />
            <ToggleSwitch
              label="Post Likes"
              ...
              setEnabled={(val) =>
                setNotifications((n) => ({ ...n, postLike: val }))
              }
            />
            <ToggleSwitch
              label="Post Comments"
              ...
              setEnabled={(val) =>
                setNotifications((n) => ({ ...n, postComment: val }))
              }
            />
            <ToggleSwitch
              label="Job Alerts"
              ...
              setEnabled={(val) =>
                setNotifications((n) => ({ ...n, jobAlerts: val }))
              }
            />
            <ToggleSwitch
              ...
              setEnabled={(val) =>
                setNotifications((n) => ({ ...n, roadmapUpdates: val }))
              }
            />
          </div>
        );
